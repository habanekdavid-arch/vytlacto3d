          ...
          {steps.map((step) => (
            ...
            >
              <div className="mx-auto flex w-fit items-center justify-center">
                <div className="group/icon relative flex h-16 w-16 items-center justify-center rounded-full bg-[#FFAE00] shadow-sm transition-all duration-500 ease-out group-hover:scale-110 group-hover:rotate-3 group-hover:shadow-xl group-hover:shadow-[#FFAE00]/30">
                  <div className="absolute inset-0 rounded-full bg-[#FFAE00] opacity-0 blur-xl transition-all duration-500 group-hover:scale-125 group-hover:opacity-40" />

                  <div className="relative z-10">{step.icon}</div>

                  <div className="absolute -right-1 -top-1 flex h-8 w-8 items-center justify-center rounded-full bg-[#000000] text-sm font-bold text-white transition-all duration-500 ease-out group-hover:-translate-y-1 group-hover:scale-110">
                    {step.number}
                  </div>
                </div>
              </div>

              <h3 className="mx-auto mt-6 max-w-xs text-2xl font-extrabold leading-snug text-neutral-900 transition-colors duration-300 group-hover:text-black">
                {step.title}
              </h3>
