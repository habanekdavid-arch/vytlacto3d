export default function MaterialPricing() {
  const materials = [
    ...
    },
    {
      ...
      eurPerGram: 14 / 1000,
      density: "1.04 g/cm³",
      use: "Technické diely, teplotná odolnosť, pevnosť",
      dot: "bg-gray-500",
    },
    {
      key: "TPU",
      ...
      eurPerGram: 15 / 1000,
      density: "1.20 g/cm³",
      use: "Flexibilné diely, tlmenie nárazov, ochranné prvky",
      dot: "bg-purple-500",
    },
  ];

  const formatEur = (n: number) => `${n.toFixed(3).replace(".", ",")} €`;

  return (
    <section id="cennik" className="bg-white px-6 py-24">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mx-auto mt-4 max-w-3xl text-center text-neutral-600">
          Transparentné ceny materiálov používaných v konfigurátore. Konečná cena
          objednávky závisí aj od času tlače, kvality a pevnosti modelu.
        </p>
            ...
            <table className="w-full min-w-[820px] text-left">
              <thead className="border-b border-neutral-200 bg-neutral-50">
                <tr className="text-sm font-semibold text-neutral-600">
                  ...
                  <th className="px-6 py-4">Použitie</th>
                </tr>
              </thead>
        ...
        <div className="mt-6 text-sm text-neutral-500">
          Cena za gram vychádza z ceny rolky (1 kg) nastavenej v kalkulácii
          výroby.
        </div>
      </div>
    </section>
